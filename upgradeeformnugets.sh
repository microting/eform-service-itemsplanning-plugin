...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add ServiceItemsPlanningPlugin.Pn.csproj package Microting.eForm
	dotnet add ServiceItemsPlanningPlugin.Pn.csproj package Microting.ItemsPlanningBase
